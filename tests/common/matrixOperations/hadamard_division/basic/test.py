...
sp.pprint(matrixA1)
sp.pprint(matrixA2)
print("Hadamard_division:")
sp.pprint(sp.Matrix(mo.hadamard_division(matrixA1, matrixA2)))
...
sp.pprint(matrixB2)
print("Hadamard_division:")
sp.pprint(mo.hadamard_division(matrixB1, matrixB2))
...
sp.pprint(matrixC2)
print("Hadamard_division:")
sp.pprint(mo.hadamard_division(matrixC1, matrixC2))