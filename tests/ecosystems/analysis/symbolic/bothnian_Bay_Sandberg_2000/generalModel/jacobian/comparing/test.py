...
inputParameters: InputParameters = InputParameters(["--dataFolder", ".", "--calculateGeneralModel"])
...
# evaluate jacobians
resultA = testDataA.generalModel.jacobian.subs(testDataA.symbolicData.getFoodWebDataSubsValues(testDataA.foodWebData))
resultB = testDataB.generalModel.jacobian.subs(testDataB.symbolicData.getFoodWebDataSubsValues(testDataB.foodWebData))
