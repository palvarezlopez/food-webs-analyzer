...
sp.pprint(sp.Matrix(mo.hadamard_product(matrixA1, matrixA2)))
...
sp.pprint(matrixB2)
print("Hadamard_product:")
sp.pprint(mo.hadamard_product(matrixB1, matrixB2))
...
sp.pprint(matrixC2)
print("Hadamard_product:")
sp.pprint(mo.hadamard_product(matrixC1, matrixC2))