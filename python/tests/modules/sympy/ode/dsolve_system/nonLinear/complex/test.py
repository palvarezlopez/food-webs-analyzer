...
# declare ecuations
equationA = sp.Eq(sp.Derivative(x(t),t), (2*x(t) + 5*y(t) + 7*x(t)*y(t) + 11))
equationB = sp.Eq(sp.Derivative(y(t),t), (13*x(t) + 17*y(t) + 19*x(t)*y(t) + 21))
...
# solve
dsolveResult = sp.solvers.ode.systems.dsolve_system(equationSystem, funcs=[x(t),y(t)], t = t, ics={x(0): 0, y(0): 0})
...
# solve
dsolveResult = sp.solvers.ode.systems.dsolve_system(equationSystem, funcs=[x(t),y(t)], t = t, ics={x(0): 1, y(0): 2})
